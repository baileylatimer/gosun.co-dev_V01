...
var videoSection = {
  ...
  createFrame: function(settings, videoDetails){
    ...
    if(videoDetails.provider === 'youtube') {
      ...
      var html = '<iframe src="//www.youtube.com/embed/'+videoDetails.id+'?&autoplay=1&mute=1&loop='+autoloop+'&rel=0&hd=1&showinfo=0&color=white&controls=0" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen  allow="autoplay"></iframe>';
    }
...
var header = {
  ...
  loadMegaMenu: function(){
    ...
    $('.mega-menu-parent').on('mouseover', function() {
...
$(document).ready(function(){
  $('#review-click').click(function(){
	 $(window).scrollTop($('#shopify-product-reviews').offset().top);
  });	
});
